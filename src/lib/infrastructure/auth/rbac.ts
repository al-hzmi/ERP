...
const RESOURCE_LABELS: Record<string, { ar: string; en: string }> = {
  ...
  'finance.fixedAsset': { ar: 'الأصول الثابتة', en: 'fixed assets' },
...
export const SYSTEM_ROLES: readonly {
  ...
  },
  {
    ...
    permissions: [
      ...
      'finance.report:read',
      // Prepares the register and its schedules; running depreciation posts to the ledger,
      // which is the controller's to do.
      'finance.fixedAsset:create',
      'finance.fixedAsset:read',
      'finance.fixedAsset:update',
      'sales.invoice:read',
