...
export const metadata = { title: 'المبيعات حسب العميل' };
...
export default async function Page({
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-semibold tracking-tight">المبيعات حسب العميل</h1>
        <p className="mt-1 text-sm text-muted-foreground">صافي المبيعات لكل عميل بين {fromDate} و{toDate}</p>
      </header>

      <ReportFilters action="/sales/analysis-by-customer" fromDate={fromDate} toDate={toDate} />
